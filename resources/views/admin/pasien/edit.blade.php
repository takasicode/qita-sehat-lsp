...
@section('content')
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    <form role="form" method="POST" action="{{ route('admin.pasien.update', $pasien->id) }}"
                        class="container p-4">
                        @csrf
                        @method('POST')
                        <div class="mb-3">
                            <label>Nama</label>
                            <input type="text" value="{{ $pasien->nama }}" name="nama" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" value="{{ $pasien->no_hp }}" name="no_hp" class="form-control"
                                placeholder="Nomor Telepon" required>
                        </div>
                        <div class="mb-3">
                            <label>Nomor KTP</label>
                            <input type="number" value="{{ $pasien->no_ktp }}" name="no_ktp" class="form-control"
                                placeholder="Nomor KTP" required>
                        </div>
                        <div class="mb-3">
                            <label>Nama Pengguna Akun</label>
                            <input type="text" value="{{ $pasien->user->username }}" placeholder="Nama Pengguna Akun"
