    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Ubah Data Poli</li>
            </ol>
        </nav>
    </div>
            ...
            <div class="col-lg-12">
                <div class="card">
                    <form role="form" method="post" action="{{ route('admin.poli.update', $poli->id) }}"
                        ...
                        <div class="mb-3">
                            <label>Nama</label>
                            <input type="text" value="{{ $poli->nama_poli }}" name="nama_poli" class="form-control"
                                placeholder="Nama Poli" required>
                        </div>
                        <div class="mb-3">
                            <label>Keterangan</label>
                            <input type="text" value="{{ $poli->keterangan }}" name="keterangan" class="form-control"
