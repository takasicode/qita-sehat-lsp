    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item ">
                    <a href="{{ route('dokter.profile') }}">Profil</a>
                </li>
                        ...
                        <div class="col-12 col-md-8 text-md-start d-grid gap-2 d-md-block">
                            ...
                            <form action="{{ route('dokter.profile.store') }}" method="post">
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-start justify-content-between pt-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input value="{{ $dokter->user->username }}" class="form-control" type="text"
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-start justify-content-between pt-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input value="{{ $dokter->nama }}" class="form-control" type="text"
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-start justify-content-between pt-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input value="{{ $dokter->no_hp }}" class="form-control" type="text"
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-start justify-content-between pt-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input value="{{ $dokter->no_ktp }}" class="form-control" type="text"
                                ...
                                <div class="d-flex flex-column flex-md-row align-items-start justify-content-between pt-3">
                                    ...
                                    <div class="col-lg-8">
                                        <input value="{{ $dokter->alamat }}" class="form-control" type="text"
